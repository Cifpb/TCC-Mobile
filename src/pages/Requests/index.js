    ...
    return (
      <View style={styles.Telaped}>
        <View style={[styles.menuLateral, { width: menuAberto ? 200 : 70 }]}>
          ...
          <TouchableOpacity 
            style={[styles.menuPedido, itemSelecionado === 'Pedidos' && styles.itemSelecionado]} 
            onPress={() => {
              setItemSelecionado('Pedidos');
          ...
          <TouchableOpacity 
            style={[styles.menuPedido, itemSelecionado === 'PedidosEmAndamento' && styles.itemSelecionado]} 
            onPress={() => {
              setItemSelecionado('PedidosEmAndamento');
              navigation.navigate('PedidosEmAndamento');
            }}
          >
          ...
          <TouchableOpacity 
            style={[styles.menuPedido, itemSelecionado === 'PedidosConcluidos' && styles.itemSelecionado]} 
            onPress={() => {
              setItemSelecionado('PedidosConcluidos');
              navigation.navigate('PedidosConcluidos');
            }}
          >
